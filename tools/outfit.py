...
def outfit_to_genome(outfit: Outfit):
    ...
    g = Genome(
        ...
        hue=_take(outfit.global_design, "hue", 0.5, "global", "design"),
        saturation=_take(outfit.global_design, "saturation", 0.6,
                          "global", "design"),
        lightness=_take(outfit.global_design, "lightness", 0.5,
                         "global", "design"),
        secondary_hue=_take(outfit.global_design, "secondary_hue", 0.5,
                             "global", "design"),
        secondary_saturation=_take(outfit.global_design,
                                     "secondary_saturation", 0.4,
                                     "global", "design"),
        secondary_lightness=_take(outfit.global_design,
                                    "secondary_lightness", 0.4,
                                    "global", "design"),
        pattern_scale=_take(outfit.global_design, "pattern_scale", 0.5,
                             "global", "design"),
        pattern_angle=_take(outfit.global_design, "pattern_angle", 0.0,
                             "global", "design"),
        trim_color_mode=0.3,
